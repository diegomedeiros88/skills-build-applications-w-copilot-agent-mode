    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4 fw-bold">Bem-vindo ao Octofit Tracker!</h1><p className="lead">Gerencie suas atividades, equipes e conquiste o topo do leaderboard!</p></div>} />
        </Routes>
      </div>
    </Router>
  );
